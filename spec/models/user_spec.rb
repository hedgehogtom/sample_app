...
describe User do
  ...
  # 2. Validate presence
  describe "when name is not present" do # test when name is empty
  	before { @user.name = " " }
  ...
  describe "when name is too long" do
  	before { @user.name = "a" * 51 }  # arbitrary cap at length 50
  	it { should_not be_valid }
  end

  # 4. Validate e-mail format
  describe "when email format is invalid" do
	...
	describe "when email format is valid" do # valid addresses are sanity checks on VALID_EMAIL_REGEX
